...
public class PrefManager {
    ...
    public static boolean getLoginState(Context context){
        SharedPreferences  sharedPreferences = context.getSharedPreferences(PrefConst.FILE_STATE,context.MODE_PRIVATE);
    ...
    public static void saveFirstTime(Context context, boolean bool){
        save(context,bool,PrefConst.KEY_FIRST_TIME,PrefConst.FILE_STATE);
    }

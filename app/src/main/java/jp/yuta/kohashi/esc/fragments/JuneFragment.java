...
public class JuneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v = inflater.inflate(R.layout.fragment_june, container, false);
     ...
     //   Log.d("json:::", text);
        ...
        text = text.replace("\n","");
        text = text.replace("\t","");
        String jsonText = getValuesBase.NarrowingValuesforJson("\"June\":[","],\"July\":",text,false);
      //  Log.d("json:::",jsonText);
      ...
      //  Log.d("test;;;;",objects.toString());
        ...
        recyclerView = (RecyclerView)v.findViewById(R.id.june_recyclerView);

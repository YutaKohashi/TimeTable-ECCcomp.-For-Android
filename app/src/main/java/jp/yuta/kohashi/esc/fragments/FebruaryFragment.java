...
public class FebruaryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_february, container, false);
     ...
     //   Log.d("json:::", text);
        ...
        text = text.replace("\n","");
        text = text.replace("\t","");
        String jsonText = getValuesBase.NarrowingValuesforJson("\"February\":[","],\"March\":",text,false);
     //   Log.d("json:::",jsonText);
      ...
      //  Log.d("test;;;;",objects.toString());
        ...
        recyclerView = (RecyclerView)v.findViewById(R.id.february_recyclerView);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            createCalenderManager.createCalender(cal.get(Calendar.YEAR) + 1, MONTH, getActivity(),dateList);

...
//        getAttendanceRateManager.getAttendanceRate(ProvisiontalActivity.this,"2140257","455478");
        ...
        rateObjectList = loadManager.loadManagerWithPreferenceForAttendance(ProvisiontalActivity.this,PREF_NAME,"attendanceList");

        recyclerView = (RecyclerView)findViewById(R.id.recycler_view1);
//        recyclerView.setHasFixedSize(true);

        layoutManager = new LinearLayoutManager(ProvisiontalActivity.this);

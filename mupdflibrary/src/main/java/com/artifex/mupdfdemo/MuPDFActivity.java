...
//        戻るボタンのクリックイベント
        ...
        //戻るボタンとページナンバーのViewの高さを合わせる
        int height = mPageNumberView.getHeight();
        mBackButtonView.setHeight(height);
    }
    ...
    private void makeButtonsView() {
        ...
        mBackButtonView=(Button)mButtonsView.findViewById(R.id.back_button);
